//
// Created by zlc on 2021/1/16.
//

/*
    使用ICP迭代最近点算法，程序随机生成一个点云与作为源点云，
    并将其沿x轴平移后作为目标点云，
    然后利用ICP估计源点云到目标点云的
    刚体变换矩阵，中间对所有信息都打印出来。
...
int main(int argc, char* *argv)
{
    ...
    std::cout << "Saved " << cloud_in->points.size() << " data points to input: " << std::endl;     // 打印处点云总数
    ...
    *cloud_out = *cloud_in;
    ...
    // 打印经过配准变换点云后的点云
    std::cout << "Assigned " << Final.points.size() << " data points: " << std::endl;
